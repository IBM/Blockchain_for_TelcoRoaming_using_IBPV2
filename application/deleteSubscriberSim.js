...
*/
/*
 * Invoke the telco-roaming-contract to delete a SubscriberSim object.
 * node deleteSubscriberSim.js <simPublicKey>
 * eg. node deleteSubscriberSim.js sim1
 *
 *
 * 1. call deleteSubscriberSim which deletes the SubscriberSim from the ledger.
 *
...
async function main() {
    ...
    channel.sendTransactionProposal(request).then((results) => {
        ...
        let regid = event_hub.registerChaincodeEvent('telco-roaming-contract', 'DeleteSimEvent-'+simPublicKey, function() {
            console.log('Found DeleteSimEvent');
            //console.log(event);
